...
//	17.12.2020  Version 3.2		- New device property DPROP_B32_ContinuousImpedance for the CGX amplifiers
//	09.02.2021  Version 3.2		- New device property DPROP_I32_SignalStrength (RSSI value in dBm)
//								 
/*------------------------------------------------------------------------------------------------*/
...
typedef enum DevicePropertyID
{
	...
	DPROP_I32_SignalStrength = 106,				// wireless signal strength  (RSSI if available)
	...
	DPROP_B32_ContinuousImpedance = 220,		// Continuous impedance measurement (FALSE=off, TRUE=on)
